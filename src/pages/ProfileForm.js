    ...
    >
      ...
      <main className="flex-grow py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          >
            <h2
              className="text-3xl sm:text-4xl font-bold mb-10 text-center text-gray-800">Профиль
              пользователя</h2>
            <form onSubmit={handleSubmit(onSubmit)}
              ...
              <div className="sm:col-span-2 lg:col-span-3">
                <label
                  className="block text-sm font-medium text-gray-800 mb-1">Навыки</label>
                <input
                  type="text"
                ...
                <div className="h-6">
                  {errors.skills && (
                    <p
                      className="text-red-500 text-sm mt-1 text-center">{errors.skills.message}</p>
                  )}
                </div>
              </div>
              ...
              <div className="sm:col-span-2 lg:col-span-3">
                <label
                  className="block text-sm font-medium text-gray-800 mb-1">Интересы</label>
                <input
                  type="text"
                ...
                <div className="h-6">
                  {errors.interests && (
                    <p
                      className="text-red-500 text-sm mt-1 text-center">{errors.interests.message}</p>
                  )}
                </div>
              </div>
              ...
              <div className="sm:col-span-1 lg:col-span-1">
                <div className="flex justify-center">
                  <div className="flex flex-col items-center">
                    <label
                      className="block text-sm font-medium text-gray-800 mb-1 text-center">Уровень
                      образования</label>
                    <select
                    ...
                    <div className="h-6">
                      {errors.educationLevel && (
                        <p
                          className="text-red-500 text-sm mt-1 text-center">{errors.educationLevel.message}</p>
                      )}
                    </div>
                  </div>
                </div>
              ...
              <div className="sm:col-span-1 lg:col-span-1">
                <div className="flex justify-center">
                  <div className="flex flex-col items-center">
                    <label
                      className="block text-sm font-medium text-gray-800 mb-1 text-center">Предпочитаемый
                      регион</label>
                    <select
                    ...
                    >
                      ...
                      <option
                        value="Восточно-Казахстанская">Восточно-Казахстанская
                      </option>
                      ...
                      <option
                        value="Северо-Казахстанская">Северо-Казахстанская
                      </option>
                      <option value="Туркестанская">Туркестанская</option>
                      <option value="Улытауская">Улытауская</option>
                      <option
                        value="Западно-Казахстанская">Западно-Казахстанская
                      </option>
                    ...
                    <div className="h-6">
                      {errors.preferredRegion && (
                        <p
                          className="text-red-500 text-sm mt-1 text-center">{errors.preferredRegion.message}</p>
                      )}
                    </div>
                  </div>
                </div>
